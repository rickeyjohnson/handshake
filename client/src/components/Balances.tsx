				...
				{accounts &&
					accounts.map((acc) => (
						...
						>
							...
							<h1 className="flex-1 min-w-0 text-sm text-center bg-stone-50 border border-stone-300 rounded-3xl px-3 py-1 text-stone-600 capitalize truncate">
								{acc.user_name}
							</h1>

							<p className="flex-[2] min-w-0 truncate">
								{acc.account_name}
							</p>
